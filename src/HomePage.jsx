...
const HomePage = () => {
	...
	return (
		<div className='relative h-full w-full px-4 lg:px-48'>
			<div className=' relative h-max w-full flex flex-col items-center gap-20 py-8'>
				<div className='relative w-full flex flex-col gap-6 items-center'>
					<h1 className='text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl text-center'>
				...
				<div className='w-full flex flex-col gap-4 items-center'>
					...
					<div className='flex flex-col md:flex-row gap-4 lg:gap-8 w-min md:w-full justify-between px-8 items-center max-w-[1000px] '>
						...
						<div className='flex items-center justify-end  w-full gap-4'>
							<div>
								...
								<p className='tracking-tighter text-right'>
									Planning ahead to ensure smooth installation
								</p>
							</div>
				...
				<div className='w-full flex flex-col gap-4 items-center'>
					...
					<div className='flex flex-col gap-6'>
						...
						<a
							...
							className='flex items-center justify-center gap-2 text-xl font-semibold text-gray-900 text-center'
						>
							<LuMail />
							Contact
						</a>
